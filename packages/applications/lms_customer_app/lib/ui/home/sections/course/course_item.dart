...
extension CourseItemActions on CourseItem {
  void routeToCourseDetailPage(BuildContext context, String courseId) {
    context.goNamed(
...
class CourseItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => routeToCourseDetailPage(context, course.id),
      child: Column(
